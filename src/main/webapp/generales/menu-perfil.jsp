    ...
    <nav class="contenedor-menu-perfil">
        <div class="opciones-menu">
            <ul>
                ...
                <a href="CreaCapitulo.jsp?idLibro=37"><li class="padding-menu"><div class="texto-centro opciones-menu-altura izquierda"><p><spring:message code="label.ncapitulo" /></p></div></li></a>
